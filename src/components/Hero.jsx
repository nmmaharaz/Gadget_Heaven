...
const Hero = () => {
    return (
        ...
        <div className='relative'>
            <div className='mx-auto absolute position top-[-120px] lg:top-[-10px]'>
            <div className='flex flex-col items-center'>
            <h1 className=' text-3xl sm:text-4xl lg:text-6xl text-white font-semibold text-center'>Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h1>
