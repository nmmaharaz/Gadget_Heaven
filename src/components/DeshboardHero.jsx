...
const DeshboardHero = () => {
    return (
        <div className='bg-[#a446f1] pt-[146px] pb-[32px]'>
            ...
            <NavLink to="/deshboard" className='btn bg-white text-xl px-7 rounded-3xl'>Cart</NavLink>
            <NavLink to="/deshboard/wishlist" className='btn bg-white text-xl px-7 rounded-3xl ml-3'>Wishlist</NavLink>
            </div>
        </div>            
    );
};
