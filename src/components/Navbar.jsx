      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
           ...
           <NavLink to='/contact' className={`${pathname == "/" || pathname == "/product/Computers" || pathname == "/product/Phones" || pathname == "/product/Smart%20Watches" || pathname == "/product/Chargers"||pathname == "/product/Power%20Banks" ?" hover:[#410571] py-2 text-white cursor-pointer font-semibold":"text-white py-2 hover:text-[#410571] font-semibold"}`}>Contact</NavLink>
          </ul>
        </div>
